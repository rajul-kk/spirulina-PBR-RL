...
# (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-2)
...
# (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-57)
LR_MAX = 5e-4
LR_MIN = 5e-5
_lr_state = {"value": LR_MAX}

# Fix #17 (v20): the behaviour-cloned controller's held-out D2-passing scores, printed beside
# (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-74)
...
# (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-82)
...
# (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-91)
...
def train_recurrent_agent(resume=False):
    ...
    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-115)
    ...
    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-147)
    best_det_score = -1.0
    ...
    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-153)
    ...
    if resume:
        ...
        if latest_checkpoint is not None:
            ...
            # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-207)
    ...
    if not resume or latest_checkpoint is None:
        ...
        model = RecurrentPPO(
            ...
            # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-268)
            gamma=0.9995,
            gae_lambda=0.98,
            # target_kl=0.02 tested in v12 and DISABLED after a clear regression: det crash
            # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-304)
            target_kl=None,
            policy_kwargs={
    ...
    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-347)
    ...
    while steps_done < TOTAL_TRAINING_STEPS and not d2_mastery_achieved and not d0_capability_abort:
        ...
        # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-360)
        ...
        # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-384)
        ...
        # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-391)
        ...
        # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-479)
        ...
        # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-500)
        ...
        # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-554)
        ...
        if stats["episodes"] >= MASTERY_MIN_EPISODES:
            ...
            if mastery_streak >= MASTERY_REQUIRED_STREAK:
                if current_difficulty == 2:
                    ...
                    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-592)
            ...
            # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-600)
            capability_failing = (
            ...
            if capability_fail_streak >= CAPABILITY_DEMOTION_CHUNKS:
                if current_difficulty > 0:
                    ...
                    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-647)
                ...
                # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-669)
        ...
        if next_difficulty != current_difficulty:
            ...
            if plateau_counter >= PLATEAU_CHUNKS:
                ...
                # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-691)
...
def finetune_recurrent_agent(extra_steps: int = 500_000):
    ...
    # (full rationale: docs/decision_history.md#--training-recurrent_ppo-py-843)
