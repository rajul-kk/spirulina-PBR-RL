...
> `docs/reports/finalresults.md`). Essentially every organism-specific parameter below (mu_max, T_opt, pH
...
> parameter values and their citations, see `docs/reference/literature.md` (Spirulina-specific,
