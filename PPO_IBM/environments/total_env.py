...
class GeneticPhotobioreactorEnv(gym.Env):
    ...
    def __init__(self, max_cells: int = 300000, initial_cells: int = 3000, difficulty: int = 2,
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-31)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-51)

        # Action: [Stirring, Light] — CO2, Nutrient, and Harvest are all automated/implicit.
        # (full rationale: docs/decision_history.md#--environments-total_env-py-59)
        self.action_space = spaces.Box(low=-1.0, high=1.0, shape=(2,), dtype=np.float32)

        # Observation Space (6 Dims)
        # (full rationale: docs/decision_history.md#--environments-total_env-py-64)
        ...
        self.harvest_integral = 0.0  # unused in batch mode (kept at 0.0, retained for obs-space compatibility)
        self.cumulative_harvested_mg = 0.0  # set once, at terminal harvest (end of the 144h batch cycle)
        ...
        # --- DAY/NIGHT CYCLE ---
        # (full rationale: docs/decision_history.md#--environments-total_env-py-135)
    ...
    def _randomize_strain(self):
        ...
        self.strain_params = {
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-153)
    ...
    def reset(self, seed: Optional[int] = None, options: Optional[Dict] = None):
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-189)
        ...
        self.harvest_integral = 0.0  # unused in batch mode — stays 0.0 all episode
        self.cumulative_harvested_mg = 0.0  # set once, at terminal harvest (curriculum metric)
    ...
    def _compute_reward(self, delta_mass_mg, total_mass_mg, shock_factor):
        ...
        # throughout the cycle, not just at the very end.
        reward_od = 0.15 * float(np.tanh(self.od / 0.20))

        # 2. Per-cell biological growth — incentivises steady healthy growth.
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-397)
        reward_stagnation = -0.010 if per_cell_growth < 0.01 else 0.0

        # 4. Washout warning — culture critically dilute (safety net only).
        reward_washout = -0.05 if self.od < 0.001 else 0.0

        reward = reward_od + reward_biomass + reward_stagnation + reward_washout

        # 5. Terminal harvest bonus — fires once, only on a natural episode end (not a
        # (full rationale: docs/decision_history.md#--environments-total_env-py-408)
        will_end_naturally = (self.step_count + 1) >= self.max_steps
        if will_end_naturally and self.num_active >= 10 and total_mass_mg >= 1.0:
            reward_terminal = 40.0 * float(np.tanh(total_mass_mg / 650.0))
            self.cumulative_harvested_mg = total_mass_mg  # single terminal harvest, whole-tank yield
    ...
    def step(self, action):
        ...
        stir_act, light_act = action

        # 1. Decode Target Actions (Stir, Light — agent-controlled; Harvest is automatic/terminal)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-460)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-535)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-543)
        ...
        if self.num_active > 0:
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-556)
            od_approx = self.od  # Use internal OD, not obs[0] (now turbidity!)
            
            # --- New Physics: 
            # (full rationale: docs/decision_history.md#--environments-total_env-py-562)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-581)
        ...
        if self.num_active > 0 and mix_intensity > 0.01:
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-597)
            
            x_pos = self.cells_x[self.active_mask]
            z_pos = self.cells_z[self.active_mask]
            
            # 1. Vertical Velocity (Vz)
            # (full rationale: docs/decision_history.md#--environments-total_env-py-605)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-673)
        ...
        if self.num_active > 0:
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-683)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-696)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-709)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-758)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-772)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-799)
            if self.ph <= 9.3:
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-808)
            ...
            # Calculate Rate
            # (full rationale: docs/decision_history.md#--environments-total_env-py-835)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-843)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-857)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-891)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-898)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-926)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-950)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-955)
            n_input_step = nut_flow * 0.79 * self.dt
            # N waste penalty removed: it caused mode collapse where agent overdosed early,
            # (full rationale: docs/decision_history.md#--environments-total_env-py-959)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-968)
            ...
            if n_dividing > 0:
                ...
                # (full rationale: docs/decision_history.md#--environments-total_env-py-1006)
            ...
            # (full rationale: docs/decision_history.md#--environments-total_env-py-1014)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1025)
        od = self.od
        avg_clump = np.mean(self.clump_mass[self.active_mask]) if self.num_active > 0 else 1.0
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1051)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1071)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1079)
        LAYER_DEPTH = 0.10
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1119)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1134)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1142)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1186)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1197)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1206)
        ...
        # --- Reward --- (see _compute_reward for the batch-cycle reward design)
        reward = self._compute_reward(delta_mass_mg, total_mass_mg, shock_factor)
        ...
        # (full rationale: docs/decision_history.md#--environments-total_env-py-1242)
        if self.num_active < 10 or total_mass_mg < 1.0:
            # Reduced from -1000: that scale was 300-1000x larger than typical achievable
            # (full rationale: docs/decision_history.md#--environments-total_env-py-1248)
            reward -= 100.0
            done = True
        else:
            done = self.step_count >= self.max_steps
            # Terminal harvest bonus (reward_terminal) was already applied above, scaled
            # to final standing biomass — this is the one-time batch-harvest yield signal.
